    ...
    const settingData = () => {
        ...
        if(calendarData!=null){
            if(!Array.isArray(calendarData)){
                ...
                data.push({"일":calendar.writeDate, "이번 달 행복 지수":calendar.happiness, "이번 달 우울 지수":calendar.sadness+calendar.anger});
                ...
                events.push({ title: '📕', start: tempDate , end: new Date(tempDate.setDate(tempDate.getDate()+3)), color:"pink", allDay:true})
